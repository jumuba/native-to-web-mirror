...
const sidebarItems = [
  ...
  { id: "photo-albums", label: "Photo Albums", icon: <ImageIcon size={13} color="#7d8699" />, active: false },
  ...
  { id: "privacy", label: "Privacy & Security", icon: <ShieldCheck size={13} color="#7d8699" />, active: false, singleLine: true },
  { id: "support", label: "Help & Support", icon: <HelpCircle size={13} color="#7d8699" />, active: false, singleLine: true },
];

function SideItem({ label, icon, active, singleLine }: { label: string; icon: React.ReactNode; active?: boolean; singleLine?: boolean }) {
  return (
    <div
...
function Card({ image, title }: { image: string; title: string }) {
  return (
    ...
    >
      <img src={image} alt={title} style={{ width: "100%", height: 88, objectFit: "cover", display: "block" }} />
      <div
        style={{
          flex: 1,
