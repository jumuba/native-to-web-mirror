          ...
          <div style={{ marginTop: 50 }}>
            ...
            >
              <div
                ...
                style={{ width: 15, height: 15, borderRadius: 3, backgroundColor: "#e6ebf7", marginRight: 7 }}
              >
            ...
            <div className="flex items-center" style={{ marginBottom: 8 }}>
              ...
              <div
                className="flex items-center"
                style={{
                  width: 237, height: 34, borderRadius: 6,
                  backgroundColor: "rgba(255,255,255,0.72)",
                  border: "1px solid rgba(214,223,241,0.95)",
                  paddingLeft: 10, paddingRight: 10, marginLeft: -3,
                }}
              >
            ...
            <div className="flex items-start justify-between" style={{ marginTop: 6 }}>
              ...
              >
                ...
                {/* How It Works */}
                <div
                  onClick={() => setSidebarScreen("how-it-works")}
                  style={{
                    marginTop: 6, borderRadius: 8,
                    backgroundColor: "rgba(255,255,255,0.48)",
                    border: "1px solid rgba(214,223,241,0.9)",
                    overflow: "hidden", height: 78, cursor: "pointer",
                  }}
                >
                  <div style={{ paddingTop: 6, paddingLeft: 6, paddingRight: 6, paddingBottom: 4 }}>
                    <p style={{ fontSize: 10.2, lineHeight: "10.2px", color: "#4150a9", fontWeight: 800, textAlign: "center", margin: 0 }}>
                      HOW IT WORKS
                    </p>
                  </div>
              ...
              <div
                style={{
                  width: 237, height: 432, overflowY: "auto", overflowX: "hidden",
