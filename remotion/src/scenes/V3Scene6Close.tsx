...
export const V3Scene6Close = () => {
  ...
  const tagY = interpolate(frame, [35, 55], [25, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
  ...
  return (
    <AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
      ...
      {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => {
        ...
        const radius = 270 + Math.sin(frame * 0.04 + i) * 20;
        return (
          <div key={i} style={{
            position: "absolute",
      ...
      <div style={{ position: "absolute", top: 580, textAlign: "center", width: "100%" }}>
        ...
        <div style={{
          opacity: subOpacity, fontSize: 22, fontFamily: poppins, fontWeight: 400,
